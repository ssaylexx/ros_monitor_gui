...
Данный проект представляет собой компонент программного пакета для мониторинга и управления мобильным роботом в среде симуляции Gazebo. Разработан в рамках дипломной работы по теме *"Создание компонентов системы контроля версий графических элементов программного пакета фреймворка ROS"*.
